...
const tablesSchema = __schema({
  device: __table({
    name: 'device',
    indexes: [
      { accessor: 'deviceId', name: 'device_device_id_idx_btree', algorithm: 'btree', columns: [
        'deviceId',
      ] },
    ],
    constraints: [
      { name: 'device_device_id_key', constraint: 'unique', columns: ['deviceId'] },
    ],
  }, DeviceRow),
  document: __table({
    name: 'document',
    indexes: [
      { accessor: 'path', name: 'document_path_idx_btree', algorithm: 'btree', columns: [
        'path',
      ] },
    ],
    constraints: [
      { name: 'document_path_key', constraint: 'unique', columns: ['path'] },
    ],
  }, DocumentRow),
});
